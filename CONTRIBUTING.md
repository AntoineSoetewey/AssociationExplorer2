...
- Add or update Roxygen2 comments so documentation is generated correctly  
...
While this project does not include a formal Code of Conduct file, contributors are expected to behave professionally and courteously.

---

## 6. Licensing

By contributing, you agree that your work will be released under the MIT license, the same license used by the package.
...
Thank you for taking the time to support and enhance AssociationExplorer2!
